                ...
                <table>
                    ...
                    <h3>Viewing a Tenant</h3>
                        ...
                        $row = $statement->fetch(PDO::FETCH_ASSOC);
                            ...
                            echo '</tr>';
                            echo '<tr>';
                            echo '<td class="vedHeaders">Address1</td>' . '<td>' . $row['DOB'] . '</td>';
                            echo '</tr>';
                            echo '<tr>';
                            echo '<td class="vedHeaders">Address2</td>' . '<td>' . $row['Gender'] . '</td>';
                            echo '</tr>';
                            echo '<tr>';
                            echo '<td class="vedHeaders">Town</td>' . '<td>' . $row['Email'] . '</td>';
                            echo '</tr>';
                            echo '<tr>';
                            echo '<td class="vedHeaders">County</td>' . '<td>' . $row['MobileNum'] . '</td>';
                            echo '</tr>';
                            echo '<tr>';
                            echo '<td class="vedHeaders">Rent</td>' . '<td>' . $row['PropertyID'] . '</td>';
                            echo '</tr>';
                            echo '<tr>';
                            echo '<td class="vedHeaders">Bedrooms</td>' . '<td>' . $row['StartLease'] . '</td>';
                            echo '</tr>';
                            echo '<tr>';
                            echo '<td class="vedHeaders">Bedrooms</td>' . '<td>' . $row['Duration'] . '</td>';
                            echo '</tr>';
                        ?>
                    </tbody>
